...
class ComposerPageQueryTool:
    ...
    def contribution_timestamp(self):
        return self.run_query('/mediawiki/page[revision/contributor/id=5558][position()=12]/revision/timestamp/text()')
    ...
    def title_timestamp(self):
        return self.run_query('/mediawiki/page[revision/timestamp="2015-02-07T22:58:31Z"]/title/text()')
